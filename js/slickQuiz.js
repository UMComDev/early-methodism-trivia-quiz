    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                nextQuestionText: 'Try another question &raquo;',
                backButtonText: '',
                ...
                animationCallbacks: { // only for the methods that have jQuery animations offering callback
                    setupQuiz: function () {},
                    startQuiz: function () {},
                    resetQuiz: function () {$('html').animate({
                        scrollTop: $(document).height()
                        }, function(){
                        $("#page_jump_input").focus();
                        });},
                    checkAnswer: function () {$('html').animate({
                        scrollTop: $(document).height()
                        }, function(){
                        $("#page_jump_input").focus();
                        });},
                    nextQuestion: function () {$('html').animate({
                        scrollTop: $(document).height()
                        }, function(){
                        $("#page_jump_input").focus();
                        });},
                    backToQuestion: function () {},
                    completeQuiz: function () {$('html').animate({
                        scrollTop: $(document).height()
                        }, function(){
                        $("#page_jump_input").focus();
                        });}
            ...
            // No idea where this needs to go
            quizFooter             = ' ',
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="button ' + tryAgainClass + '" href="#" rel="nofollow">' + plugin.config.tryAgainText + '</a></p>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.perQuestionResponseMessaging || plugin.config.completionResponseMessaging) {
                            ...
                            responseHTML.append('<li class="' + correctResponseClass + '"><p><h3>Correct!</h3>' + question.learnMore + quizFooter + '</p></li>');
                            responseHTML.append('<li class="' + incorrectResponseClass + '"><p><h3>Incorrect.</h3>' + question.learnMore + quizFooter + '</p></li>');
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#"  rel="nofollow" class="button ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<a href="#"  rel="nofollow" class="button ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a>');
                        } else {
                            questionHTML.append('<a href="#"  rel="nofollow" class="button ' + nextQuestionClass + '">' + nextText + '</a>');
                            questionHTML.append('<a href="#"  rel="nofollow"  class="button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        }
            ...
            calculateLevel: function(correctAnswers) {
                ...
                if (plugin.method.inRange(0, 0.31, percent)) {
                    level = 2;
                } else if (plugin.method.inRange(0.32, 0.71, percent)) {
                    level = 1;
                } else if (plugin.method.inRange(0.72, 1.00, percent)) {
                    level = 0;
                }
